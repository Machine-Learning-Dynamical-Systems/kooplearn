...
def fit_brunton_model_example(
    num_samples, num_features, lb_window_size, num_complex_pairs, num_real, epochs
):
    seed = 42
    ...
    number_of_consecutive_time_steps_generated = max(
        m_time_steps_linear_dynamics, m_time_steps_future_state_prediction
    )
...
def test_fit():
    ...
    num_complex_pairs = 5
    num_real = 3
    model, X_train = fit_brunton_model_example(
